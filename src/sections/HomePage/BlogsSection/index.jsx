                ...
                <div className="flex flex-col justify-between pl-3 sm:pl-4 lg:pl-4 w-3/5 sm:w-3/5 lg:w-1/2">
                  ...
                  <div className="flex items-center gap-2 mb-2 sm:mb-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="font-medium text-text-primary text-[10px] sm:text-xs truncate">{blog.author}</p>
                      <p className="text-[9px] sm:text-[10px] text-text-secondary">{blog.date}</p>
                    </div>
                  </div>
